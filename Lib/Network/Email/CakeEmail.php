 ...
 * @var string
 */
	protected $_transportName = 'ProMailQueue.MailQueue';
 ...
 */
    ...
    public $iam = 'ProMailQueue.CakeEmail';
/**
 * Constructor
 ...
 * Added for ProMailQueue
 */
    public function getFrom( $asText=null ) {
        if ( $asText == 'text' ) {
            return $this->_from[key($this->_from)]  . ' <' .key($this->_from) . '>';
        }
        return $this->_from;
    }
 ...
 */
	public function send($content = null) {
        ...
        //ProMailQueue Debug data 
        $traces = debug_backtrace(); 
        if (isset($traces[2])) { 
            $this->_pmq_debug['caller'] = $traces[2]['object']->class . '::' . $traces[2]['object']->name . '()';
            $this->_pmq_debug['backtrace'] = $traces;
        }
